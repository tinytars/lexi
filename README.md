...
- `apps/health-dash-web` (planned) — LexiTar itself will move here from the private monorepo it was
  built in, and will consume `@tinytars/frame` as a real package dependency rather than a same-repo
  relative import.

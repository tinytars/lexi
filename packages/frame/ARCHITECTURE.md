...
This is the contract, not a tour — see this package's `README.md` section in the repo root
`README.md` for the featureset summary an architect scans first. What follows is what a reader
needs to adopt the package, write a new controller, or judge whether a change to an existing one
is safe.
